  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-card fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-250 data-[state=open]:duration-250 data-[state=open]:animate-in data-[state=closed]:animate-out",
          side === "right" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus-visible:ring-ring absolute top-4 right-4 rounded-full opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus:outline-none disabled:pointer-events-none">
