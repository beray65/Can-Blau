  ...
  function initHeroShader() {
    ...
    function compile(type, src) {
      ...
      if (!gl.getShaderParameter(s, gl.COMPILE_STATUS)) {
        console.warn("[initHeroShader] shader compile failed:", gl.getShaderInfoLog(s));
      }
      return s;
    }
    ...
    if (!gl.getProgramParameter(prog, gl.LINK_STATUS)) {
      console.warn("[initHeroShader] program link failed:", gl.getProgramInfoLog(prog));
      return;
    }
    gl.useProgram(prog);
